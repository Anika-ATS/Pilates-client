...
const AllUsers = () => {
    ...
    const { data: users = [], refetch } = useQuery(['users'], async () => {
        const res = await fetch('https://y-opal-kappa.vercel.app/users')
        console.log(res)
        return res.json();
    })
    //dlete user
    ...
    const handleAdmin = user => {
        fetch(`https://y-opal-kappa.vercel.app/users/admin/${user._id}`, { method: 'PATCH' })
            .then(res => res.json())
            .then(data => {
                console.log(data)
  ...
  //handle instructor
   const handleInstructor= user => {
        fetch(`https://y-opal-kappa.vercel.app/users/instructor/${user._id}`, { method: 'PATCH' })
        .then(res => res.json())
        .then(data => {
            console.log(data)
            if (data.modifiedCount) {
